...
public class SysUserController extends AbstractController {
     ...
     */
    @GetMapping("/exlist")
    @RequiresPermissions("sys:user:exlist")
    public R exList(@RequestParam Map<String, Object> params) {
        params.put("external", Constant.YesOrNo.YES.getValue());
        PageUtils page = sysUserService.queryPage(params);
    ...
    public R save(@RequestBody SysUserEntity user) {
        ...
        user.setExternal(Constant.YesOrNo.NO.getValue());
