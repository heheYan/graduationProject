...
public class SysUserServiceImpl extends ServiceImpl<SysUserDao, SysUserEntity> implements SysUserService {
	 ...
	 */
	@Override
	public List<SysUserEntity> getRepairUserList(String roleName) {
		return baseMapper.getRepairUserList(roleName);
	}
